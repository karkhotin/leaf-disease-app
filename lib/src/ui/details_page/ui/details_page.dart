...
import 'package:leaf_disease_app/src/ui/details_page/bloc/details_bloc.dart';
...
import 'package:leaf_disease_app/src/ui/details_page/ui/leaf_dease_view.dart';
    ...
    return MaterialPageRoute(
      ...
      builder: (context) => BlocProvider(
        create: (context) => DetailsCubit(
          state,
          leafDeaseDetectionRepository: context.read<LeafDeaseDetectionRepository>(),
        ),
